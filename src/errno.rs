...
fn desc(errno: Errno) -> &'static str {
    ...
    match errno {
        ...
        #[cfg(any(target_os = "freebsd", target_os = "dragonfly", target_os = "solaris"))]
        EMULTIHOP       => "Multihop attempted",

        #[cfg(any(target_os = "freebsd", target_os = "dragonfly", target_os = "solaris"))]
        ENOLINK         => "Link has been severed",

        #[cfg(arget_os = "freebsd")]
        ...
        #[cfg(any(target_os = "macos", target_os = "freebsd", target_os = "ios", target_os = "solaris"))]
        ENOTRECOVERABLE => "State not recoverable",
        ...
        #[cfg(any(target_os = "macos", target_os = "ios", target_os = "solaris"))]
